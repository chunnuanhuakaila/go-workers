...
func (m *m1) Call(queue string, message *Msg, next func() CallResult) (result CallResult) {
...
func (m *m2) Call(queue string, message *Msg, next func() CallResult) (result CallResult) {
